...
def main():
  ...
  parser.add_argument("--task", type=str, nargs="+",
                      # default=['SST-2', 'sst-5', 'mpqa', 'cr', 'mr', 'subj', 'trec', 'CoLA', 'MRPC', 'QQP', 'STS-B', 'MNLI', 'SNLI', 'QNLI', 'RTE'],
                      # default=['SST-2', 'mpqa', 'cr', 'mr', 'subj', 'CoLA', 'MRPC', 'QQP', 'MNLI', 'SNLI', 'QNLI', 'RTE'],
                      default=['SST-2'],
                      help="Task names")
  ...
  parser.add_argument("--data_dir", type=str, default="../../rsc/eng_original", help="Path to original data")
  parser.add_argument("--output_dir", type=str, default="../../rsc/eng_few_shot", help="Output path")
