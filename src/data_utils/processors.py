...
class TextClassificationProcessor(DataProcessor):
  """
  Data processor for text classification datasets (mpqa, sst-5, subj, trec, cr, mr).
  """
  ...
  def _create_examples(self, lines, set_type):
    ...
    for (i, line) in enumerate(lines):
      ...
      elif self.task_name in ['mpqa', 'sst-5', 'subj', 'trec', 'cr', 'mr']:
